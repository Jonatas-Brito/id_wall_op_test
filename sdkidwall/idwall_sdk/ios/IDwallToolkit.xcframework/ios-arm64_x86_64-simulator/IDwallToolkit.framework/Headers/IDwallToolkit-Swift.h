...
SWIFT_CLASS("_TtC13IDwallToolkit16DocumentTypeCard")
@interface DocumentTypeCard : UIView
...
SWIFT_CLASS("_TtC13IDwallToolkit21IDwallBehaviorAddress")
@interface IDwallBehaviorAddress : NSObject
...
SWIFT_CLASS("_TtC13IDwallToolkit25IDwallDigitalDocumentFlow")
@interface IDwallDigitalDocumentFlow : IDwallCoordinator
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC13IDwallToolkit21IDwallDocumentCapture")
@interface IDwallDocumentCapture : IDwallCoordinator
...
@interface IDwallDocumentCapture (SWIFT_EXTENSION(IDwallToolkit))
+ (IDwallDocumentCapture * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (void)request:(enum IDDocumentType)documentType andDocSide:(enum IDDocSide)documentSide andCallback:(void (^ _Nullable)(BOOL, NSError * _Nullable))callback;
...
- (void)sendDataWithCallback:(void (^ _Nullable)(NSDictionary * _Nullable, NSError * _Nullable))callback;
@end
...
SWIFT_PROTOCOL("_TtP13IDwallToolkit30IDwallRepositoryHelperProtocol_")
@protocol IDwallRepositoryHelperProtocol
+ (id <IDwallRepositoryHelperProtocol> _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (void)sendDataWithDataType:(enum IDWallSend)dataType andCallBack:(void (^ _Nonnull)(NSDictionary * _Nullable, NSError * _Nullable))callback;
- (BOOL)hasAuthKey SWIFT_WARN_UNUSED_RESULT;
- (void)resetAllImages;
@end


SWIFT_CLASS("_TtC13IDwallToolkit22IDwallRepositoryHelper")
@interface IDwallRepositoryHelper : NSObject <IDwallRepositoryHelperProtocol>
+ (id <IDwallRepositoryHelperProtocol> _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (void)sendDataWithDataType:(enum IDWallSend)dataType andCallBack:(void (^ _Nonnull)(NSDictionary * _Nullable, NSError * _Nullable))callback;
- (BOOL)hasAuthKey SWIFT_WARN_UNUSED_RESULT;
- (void)resetAllImages;
